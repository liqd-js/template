...
{
    #templates; #compiled = new Map(); #id_generator = new UniqueID({ prefix: '_', unique_interval: 3600, radix: 64 }); #ready = false; #initialization;
    ...
    render( path = '', name, props = {}, scope = {}, locale = 'en', content = NO_CONTENT )
    {
        ...
        return template([ this.#id_generator.get(), locale, content, props, scope, ( name, props, content ) => this.render( template.path, name, props, scope, locale, content || NO_CONTENT ) ]);
